...
# Process the description to remove unnecessary text
def process_description(desc):
    """Extract 'TEF' and remove redundant prefixes."""
    if 'TEF BANCOESTADO DE' in desc:
        return 'TEF', desc.replace('TEF BANCOESTADO DE ', '')
    elif 'TEF DE' in desc:
        return 'TEF', desc.replace('TEF DE ', '')
    return '', ''
...
# Create dictionaries for counting TEFs
